...
// DO NOT EDIT OR ADD ANY CODE HERE!
	...
	private void $$$setupUI$$$() {
		...
		panel1.add(ringVolumeSlider, new GridConstraints(2, 1, 1, 2, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_HORIZONTAL, GridConstraints.SIZEPOLICY_WANT_GROW, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		final JLabel label4 = new JLabel();
		label4.setText("Show popup notification:");
		label4.setToolTipText(ResourceBundle.getBundle("resources/messages").getString("settings.popup.tooltip"));
		...
		label5.setText("Block IDE during break:");
		label5.setToolTipText(ResourceBundle.getBundle("resources/messages").getString("settings.blockCheckbox.tooltip"));
		...
		label6.setText("Show tool window:");
		...
		label8.setText("minute(s)");
		panel1.add(label8, new GridConstraints(0, 2, 1, 1, GridConstraints.ANCHOR_WEST, GridConstraints.FILL_NONE, GridConstraints.SIZEPOLICY_FIXED, GridConstraints.SIZEPOLICY_FIXED, null, null, null, 0, false));
		label1.setLabelFor(pomodoroLengthComboBox);
		label2.setLabelFor(breakLengthComboBox);
	}
